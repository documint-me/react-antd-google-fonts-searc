...
var SearchContext = React__default["default"].createContext({
    editFontOpen: false,
...
var SearchProvider = function (_a) {
    ...
    var suggest = React.useCallback(function (_key) { }, []);
    ...
    return (React__default["default"].createElement(SearchContext.Provider, { value: {
...
var FontSkeleton = function () {
    ...
    return (React__default["default"].createElement(antd.Col, { span: isGrid ? 6 : 24 },
        React__default["default"].createElement(antd.Card, null,
            React__default["default"].createElement(antd.Skeleton, { active: true }))));
};
        ...
        React__default["default"].createElement(antd.Card, { onClick: function () {
            ...
            React__default["default"].createElement(antd.Row, { gutter: [16, 16] },
                React__default["default"].createElement(antd.Col, { span: 12 },
                    React__default["default"].createElement(Text$5, { strong: true }, font.family)),
                React__default["default"].createElement(antd.Col, { span: 12, style: { display: 'flex', justifyContent: 'flex-end' } },
                    React__default["default"].createElement(Text$5, { type: "secondary" },
                ...
                React__default["default"].createElement(antd.Col, { span: 24 },
                    React__default["default"].createElement("div", { className: "preview", style: {
                        ...
                        React__default["default"].createElement("div", null,
                            React__default["default"].createElement("span", null, text === 'fontName' ? font.family : text))))))));
};
var Fonts = function () {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        loading && (React__default["default"].createElement(antd.Row, { gutter: [16, 16], className: "fonts-body" }, [1, 2, 3, 4, 5, 6, 7, 8].map(function (val) { return (React__default["default"].createElement(FontSkeleton, { key: val })); }))),
        !loading && (React__default["default"].createElement(React__default["default"].Fragment, null, fonts.length ? (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement("div", { className: "flex-center" },
                React__default["default"].createElement(antd.Pagination, { simple: true, current: page, total: fonts.length, defaultPageSize: PAGE_SIZE, onChange: setPage })),
            React__default["default"].createElement(antd.Row, { gutter: [16, 16], className: "fonts-body" }, currentFonts.map(function (font, i) { return (React__default["default"].createElement(Font$1, { key: i, font: font })); })),
            React__default["default"].createElement("div", { className: "flex-center" },
                React__default["default"].createElement(antd.Pagination, { simple: true, current: page, onChange: setPage, defaultPageSize: PAGE_SIZE, total: fonts.length })))) : (React__default["default"].createElement(antd.Row, { gutter: [16, 16], className: "fonts-body" },
...
var SearchInput = function () {
    ...
    return React__default["default"].createElement(Search, { placeholder: "input search text", value: search, onChange: function (e) { return setSearch(e.target.value); } });
};

var SortInput = function () {
    var _a = useSearchContext(), sort = _a.sort, setSort = _a.setSort;
    return (React__default["default"].createElement(antd.Select, { value: sort, style: { width: '100%' }, onChange: setSort, options: [
...
var ToggleView = function () {
    ...
    return (React__default["default"].createElement(antd.Segmented, { value: view, onChange: function (value) { return setView(value.toString()); }, options: [
            {
                label: '',
                value: 'grid',
                icon: React__default["default"].createElement(icons.AppstoreOutlined, null),
            },
            {
                label: '',
                value: 'list',
                icon: React__default["default"].createElement(icons.BarsOutlined, null),
            },
        ] }));
};
...
var Preview = function () {
    ...
    return (React__default["default"].createElement(antd.Row, { gutter: [16, 16] },
        React__default["default"].createElement(antd.Col, { span: 24 },
            React__default["default"].createElement(antd.Button, { type: "text", icon: React__default["default"].createElement(icons.ReloadOutlined, null), onClick: randomizeText }, "Randomize")),
        React__default["default"].createElement(antd.Col, { span: 24 },
            React__default["default"].createElement(TextArea, { placeholder: "Type something...", value: text, onChange: function (e) { return setText(e.target.value); } })),
        React__default["default"].createElement(antd.Col, { span: 4, style: { alignContent: 'center' } },
            React__default["default"].createElement(Text$4, { type: "secondary" },
                previewSize,
                "px")),
        React__default["default"].createElement(antd.Col, { span: 20 },
            React__default["default"].createElement(antd.Slider, { value: previewSize, onChange: setPreviewSize }))));
};
...
var ResetAllButton = function () {
    ...
    return (React__default["default"].createElement(antd.Button, { type: "text", icon: React__default["default"].createElement(icons.ReloadOutlined, null), onClick: resetAll }, "Reset"));
};

var Text$2 = antd.Typography.Text;
var ResultsCount = function () {
    var fonts = useSearchContext().fonts;
    return (React__default["default"].createElement(Text$2, { type: "secondary" },
        fonts.length,
        " results"));
};
...
var useFontSettings = function (fonts, setFonts, onChange) {
    var saveFont = React.useCallback(function (font) {
    ...
    var deleteFont = React.useCallback(function (font) {
...
var EditFont = function (_a) {
    ...
    var getCheckboxValues = React.useCallback(function (item) {
    ...
    var _c = React.useState(getCheckboxValues('variants')), variants = _c[0], setVariants = _c[1];
    var _d = React.useState(getCheckboxValues('subsets')), subsets = _d[0], setSubsets = _d[1];
    React.useEffect(function () {
        setVariants(getCheckboxValues('variants'));
        setSubsets(getCheckboxValues('subsets'));
    }, [font, currentSavedFont]);
    return (React__default["default"].createElement(antd.Modal, { title: font.family, okText: "Save", open: editFontOpen, onOk: function () {
            if (allFalse(variants) || allFalse(subsets)) {
                antd.message.info('Select at least one subset and one variant');
            }
            else {
...
var Font = function (_a) {
    ...
    return (React__default["default"].createElement(antd.Col, { span: 24 },
        React__default["default"].createElement(antd.Card, { style: { cursor: 'pointer' }, onClick: function () {
                WebFont.load({
                    classes: false,
                    google: {
                        families: [font.family + ':' + font.variants.join(',') + ':' + font.subsets.join(',')],
...
var SearchLayout = function (_a) {
    ...
    var _b = React.useState(false), openFilters = _b[0], setOpenFilters = _b[1];
    var _c = React.useState(false), openSettings = _c[0], setOpenSettings = _c[1];
    return (React__default["default"].createElement(SearchProvider, { addedFonts: addedFonts },
        React__default["default"].createElement(EditFont, { onChange: onChange }),
        React__default["default"].createElement(antd.Space, { direction: "vertical", size: "middle", style: { display: 'flex' } },
            React__default["default"].createElement(antd.Drawer, { title: React__default["default"].createElement(ResetAllButton, null), placement: "right", onClose: function () { return setOpenFilters(false); }, open: openFilters },
                React__default["default"].createElement(antd.Divider, { orientation: "left" }, "Preview"),
                React__default["default"].createElement(Preview, null),
                React__default["default"].createElement(antd.Divider, { orientation: "left" }, "Filters"),
                React__default["default"].createElement(Filters, null)),
            React__default["default"].createElement(antd.Drawer, { title: "My Fonts", placement: "right", onClose: function () { return setOpenSettings(false); }, open: openSettings },
                React__default["default"].createElement(antd.Row, { gutter: [16, 16] },
                    React__default["default"].createElement(AddedFonts, { onChange: onChange }))),
            React__default["default"].createElement(antd.Row, { gutter: [16, 16] },
                React__default["default"].createElement(antd.Col, { span: 21 },
                    React__default["default"].createElement(SearchInput, null)),
                React__default["default"].createElement(antd.Col, { span: 3, className: "flex-end" },
                    React__default["default"].createElement(SortInput, null)),
                React__default["default"].createElement(antd.Col, { span: 24 },
                    React__default["default"].createElement(antd.Button, { shape: "round", onClick: function () { return setOpenFilters(!openFilters); }, type: "primary", icon: openFilters ? React__default["default"].createElement(icons.CloseOutlined, null) : React__default["default"].createElement(icons.FilterOutlined, null), style: { marginRight: 5 } }, "Filters"),
                    React__default["default"].createElement(antd.Button, { shape: "round", onClick: function () { return setOpenSettings(!openSettings); }, type: openSettings ? 'primary' : 'default', icon: openSettings ? React__default["default"].createElement(icons.CloseOutlined, null) : React__default["default"].createElement(icons.SettingOutlined, null) }, "Manage My Fonts"))),
            React__default["default"].createElement(antd.Row, { gutter: [16, 16] },
                React__default["default"].createElement(antd.Col, { span: 12 },
...
exports.GoogleFontsSearch = SearchLayout;
exports.getLinkFormats = getLinkFormats;
exports.grapesjsGoogleFonts = plugin;
